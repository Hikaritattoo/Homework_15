...
--TRIM используется, чтоб скорректировать данные на уровне базы, если есть пробел, убирает его, выравнивает данные по левому краю--
--UNION берет одно из двух пересекающихся значений, избегая повторов в базе при объединении двух таблиц--
